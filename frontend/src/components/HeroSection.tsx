    ...
    <div className="h-[530px] lg:h-[700px] 2xl:mx-[300px]">
      <div className="flex flex-col items-center lg:mt-[130px] py-[100px] text-white gap-2.5">
        ...
        <div className="mt-[11.5px]">
          <p className="text-[50px] md:text-[58px] lg:text-[64px] font-medium text-center mt-1 px-[20px] md:px-[100px] lg:px-[210px] leading-[76.8px]">Discover the Beauty of Nature at Your Fingertips</p>
        </div>
        <div className="h-[66px] flex items-end mt-[11px]">
