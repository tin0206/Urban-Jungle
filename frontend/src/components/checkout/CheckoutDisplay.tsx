...
export default function CheckoutDisplay() {
  ...
  const fetchCartItems = async () => {
    if (user === null) {
      ...
      await fetch("https://urbanjunglewebapplication-env.eba-bwwrnbuw.ap-southeast-1.elasticbeanstalk.com/api/plants/localStorage", {
        method: "POST",
        headers: {
  ...
  const handlePlaceOrder = async () => {
    ...
    const fetchCartItems_local = async () => {
       if (user === null) {
        const plants_ids = cart.map((item: CartItem) => item.id)
        const response = await fetch("https://urbanjunglewebapplication-env.eba-bwwrnbuw.ap-southeast-1.elasticbeanstalk.com/api/plants/localStorage", {
          method: "POST",
        ...
        const response = await fetch("https://urbanjunglewebapplication-env.eba-bwwrnbuw.ap-southeast-1.elasticbeanstalk.com/api/shopping_cart/items", {
          method: "GET",
          headers: {
            "Content-Type": "application/json",
            "Authorization": `Bearer ${localStorage.getItem("jwt_token")}`,
    ...
    const response = await fetch("https://urbanjunglewebapplication-env.eba-bwwrnbuw.ap-southeast-1.elasticbeanstalk.com/api/place_order", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
    ...
    if (response.ok) {
      ...
      try {
        if (user === null) {
          ...
          await fetch("https://urbanjunglewebapplication-env.eba-bwwrnbuw.ap-southeast-1.elasticbeanstalk.com/api/shopping_cart/clearCart", {
            method: "POST",
            headers: {
              "Content-Type": "application/json",
              "Authorization": `Bearer ${localStorage.getItem("jwt_token")}`,
