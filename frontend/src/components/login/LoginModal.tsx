...
export default function LoginModal() {
    ...
    const handleSubmit = async (e: any) => {
        ...
        if (showSignUpModal) {
            try {
                const response = await fetch("http://urbanjunglewebapplication-env.eba-bwwrnbuw.ap-southeast-1.elasticbeanstalk.com/api/signup", {
                    method: "POST",
                    headers: {
            ...
            try {
                const response = await fetch("http://urbanjunglewebapplication-env.eba-bwwrnbuw.ap-southeast-1.elasticbeanstalk.com/api/login", {
                    method: "POST",
                    headers: {
                        "Content-Type": "application/json"
                    },
    ...
    const synchronizeCart = async () => {
        ...
        if (matchItems.length > 0) {   
            await fetch("http://urbanjunglewebapplication-env.eba-bwwrnbuw.ap-southeast-1.elasticbeanstalk.com/api/shopping_cart/updateCart", {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                    "Authorization": `Bearer ${localStorage.getItem("jwt_token")}`,
        ...
        if (dbLackingItems.length > 0) {
            await fetch("http://urbanjunglewebapplication-env.eba-bwwrnbuw.ap-southeast-1.elasticbeanstalk.com/api/shopping_cart/updateCartFromLocalStorage", {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                    "Authorization": `Bearer ${localStorage.getItem("jwt_token")}`,
